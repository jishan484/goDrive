...
DBChanges.changes.secondOrder.push(require('./SharedFileInfo.js'));   // Shared Files Info table creation
DBChanges.changes.secondOrder.push(require('./FileRequestInfo.js'));   // File Request Info table creation
