...
var _folder_scroll_position_history = [];
var _currentClipboard={active:false, type:'', path:'', id:'', name:'', size:''};
var _currentUploadsNewFolderList = [];
var _currentUploadedFolderList = new Map();
var _currentUploadsCounter = -1;
var _consecutiveUploadsCounter = 5; // max 5 uploads at a time // not to be chaged
